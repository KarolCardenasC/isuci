...
/**
 * ContrarrelojeroDTO is a data transfer object representing a cyclist specialized in time trials. 
 * It extends CiclistaDTO and implements the Serializable interface for object serialization.
 * This class includes a property for the maximum speed.
 * 
 * @author Cardenas.K
 * @version 10/05/2024
 * @see CiclistaDTO
...
public class ContrarrelojeroDTO extends CiclistaDTO implements Serializable {
	...
	/**
     * Constructor with parameters for all properties except image, name, ID, email, username, and maximum speed.
     * 
     * @param imagen                  The image URL.
     * @param nombre                  The name.
     * @param cedula                  The ID number.
